import math
import csv
import datetime # Importamos datetime para la fecha/hora del registro
...
def calcular_tmb(genero_simplificado, peso, estatura_cm, edad):
    ...
    Parámetros:
    - genero_simplificado (str): 'h' para hombre o 'm' para mujer.
    ...
    genero_completo = 'hombre' if genero_simplificado.lower() == 'h' else 'mujer'
...
def registrar_usuario():
    ...
    # Género simplificado: 'h' para hombre, 'm' para mujer
    genero = solicitar_opcion_str("Género (H/M): ", ['h', 'm'])
    ...
    if opcion_objetivo == '1': # Pérdida de Peso
        ...
        min_calorias = 1500 if genero.lower() == 'h' else 1200
    ...
    try:
        ...
        with open("registros_nutricionales.txt", "a", encoding='utf-8') as archivo:
            ...
            archivo.write(f"Género: {'Hombre' if genero == 'h' else 'Mujer'}\n") # Guarda el género completo
